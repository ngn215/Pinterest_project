...
<?php
			...
			from
				...
				from
					pinboards pb, pinboards pb2, pinboards pb1, picture_pinboard p_pb, pictures p, users u, users u1
				where
			...
			if($count==0)
				...
				?>
					...
					<?php
					if(!isset($_SESSION['user_id']))
						echo "<font style='font-size:13px;'>Likes:</font>";
					?>					
				...
				<td align="center">
									<?php
					if(!isset($_SESSION['user_id']))
						echo "<font style='font-size:13px;'>Repins:</font>";
					?>
				<font style="color:rgb(205,31,40); font-size:11px"">
